...
namespace mise.external
{
    public class Impressora
    {
        ...
        public void Imprimir(string txt)
        {
            ...
            int retorno = BematechTX(txt);
            if (retorno != 1)
            {
                throw new Exception("Não foi possível comunicar com a impressora!");
            }
        ...
        public void AbrirGaveta()
        {
            if (!_MOCK)
            {
                ...
                if (retorno != 1)
                {
                    throw new Exception("Erro ao abrir gaveta: gaveta indisponível!");
                }
            }
        }
        ...
        public void CortarPapel()
        {
            if (!_MOCK)
            {
                ...
                if (retorno != 1)
                {
                    throw new Exception("Erro ao cortar papel: impressora indisponível!");
                }
            }
        }
        ...
        private void VerificarConexao()
        {
            ...
            if (status != 24)
            {
                switch (status)
                {
                    ...
                    default:
                        throw new Exception("Erro desconhecido ao tentar imprimir!");
                }
            }
        }
